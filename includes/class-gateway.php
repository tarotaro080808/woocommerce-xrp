...
class WC_Gateway_XRP extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        add_action( 'woocommerce_thankyou', array( $this, 'thankyou_xrp_payment_info' ), 10 );
        add_action( 'woocommerce_view_order', array( $this, 'thankyou_xrp_payment_info' ), 10 );
    ...
    public function thankyou_xrp_payment_info( $order_id ) {
